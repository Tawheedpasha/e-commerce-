				...
				<div class="card-body--">
                   ...
                   <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>  <td class="product-add-to-cart">
                                                  
                                                <a href="order_master_details.php?id=<?php echo $row['id']?>"> view </a></td>
                                                ...
                                                <td class="product-thumbnail"><a href="#"><?php echo $row['order_status_str']?></a></td>
